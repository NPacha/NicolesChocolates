...
##### Updated to modern react (functional components, hooks, async/await) on front end, and updated mongoose, modern js syntax, and hashed passwords on back end - by Ira Herman 8/2020
