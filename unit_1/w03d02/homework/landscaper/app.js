...
// const buyToolButton = document.querySelector('.buytool').addEventListener('click', pickTool());

// const mowLawnButton = document.querySelector('.mowlawn').addEventListener('click', function () {alert('Hi Yo')});
