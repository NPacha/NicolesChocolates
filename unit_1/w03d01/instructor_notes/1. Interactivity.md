...
## :fireworks: Thinking Programmatically
...
1. Reference the file inside a script tag inside the `<head>` tag of your html file
    ...
    ```
1. Create a new folder called `interactivity` in your `student_examples` folder
1. Add an `index.html` file, a `js` folder and a `script.js` file to this folder.
1. Connect the `script.js` to your `index.html` file and open the `index.html` file in your browser! 
...
## :fireworks: Problem solving for a bigger program
...
- Write a program in your browser console for making a bowl of cereal
