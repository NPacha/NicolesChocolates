...
:star: Error messages are good. They are not adversarial! They are there to help you.

:star: Error messages are **clues** that you learn to read. You should be able to read these clues on your own.
...
- There is much debate about whether to use semicolons in JS. The interpreter will implicitly add them for you at the end of certain lines. Let's look at the example below.
