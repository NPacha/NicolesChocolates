...
Earth has been attacked by a horde of aliens! You are the captain of the USS Ruth, on a mission to destroy every last alien ship.
...
**Your spaceship, the USS Ruth** should have the following properties:
...
<details>
<summary>
Expand cheat code/suggestions
</summary>
<hr>

Make the USS_Ruth object.

Make a single alien ship object.

Simulate a battle between your ship and a single alien ship first.

Make a method for the USS Ruth that will attack a given target. The target can be an input to the method.
...
Make a method in the game object that will run a 'check win' for the health of the alien(s) and/or the USS Ruth. If the hull is 0 or less, display a message that the ship went kabloo-ey.
...
Submit your homework via github issues before the next class starts at 10AM.
